...
enum KindOfType CPP_11(: Int)
{
	...
	KINDOF_MOBILE_STRUCTURE,				///< Reborn: structure that is allowed to move
	KINDOF_MOVES_REVERSE,				    ///< Reborn: flips the object facing
  ...
  KINDOF_EMP_HARDENED,            ///< Like a delivery plane (B52, B3, CargoPlane,etc.)  or a SpectreGunship, which sort-of IS the weapon...
	...
	KINDOF_AIRCRAFT_CARRIER_RO,		  ///< Reborn: Aircraft carrier that is buildable
