...
#define CASE_LABEL(x) case x: return #x;
	...
	CASE_LABEL(MSG_META_BEGIN_POWER_MODE)
	CASE_LABEL(MSG_META_END_POWER_MODE)
	...
	CASE_LABEL(MSG_REBORN_TOGGLE_AUTO_ACQUIRE) // Reborn: Toggle automatic enemy acquisition
